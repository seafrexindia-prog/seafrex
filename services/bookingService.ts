...
const INITIAL_BOOKINGS: Booking[] = [
  // 1. INCOMING BOOKING (Client View Mock)
  {
    id: 'BKG-1001',
    bookingRef: 'PENDING',
    offerId: '3',
  ...
  // 2. OUTGOING BOOKING (Provider View Mock)
  {
    id: 'BKG-1002',
    bookingRef: 'PENDING',
    offerId: '5',
